// Package cuisinecore provides authorization functionality using Casbin for role-based access control (RBAC).
...
import (
	...
	commonv1 "buf.build/gen/go/cuisinea/common/protocolbuffers/go/cuisinea/common/v1"
